 ...
 *
 * @see BeeperDesktop\Services\Matrix\Rooms\AccountDataService::retrieve()
 *
 * @phpstan-type AccountDataRetrieveParamsShape = array{
...
final class AccountDataRetrieveParams implements BaseModel
{
     ...
     * ```
     * AccountDataRetrieveParams::with(userID: ..., roomID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AccountDataRetrieveParams)->withUserID(...)->withRoomID(...)
     * ```
     */
     ...
     */
    public static function with(string $userID, string $roomID): self
    {
        $self = new self;

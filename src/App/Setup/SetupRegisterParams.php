 ...
 *
 * @see BeeperDesktop\Services\App\SetupService::register()
 *
 * @phpstan-type SetupRegisterParamsShape = array{
 *   acceptTerms: bool, leadToken: string, setupRequestID: string, username: string
 * }
 */
final class SetupRegisterParams implements BaseModel
{
    /** @use SdkModel<SetupRegisterParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SetupRegisterParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SetupRegisterParams::with(leadToken: ..., setupRequestID: ..., username: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SetupRegisterParams)
     *   ->withLeadToken(...)
     *   ->withSetupRequestID(...)
     *   ->withUsername(...)
     * ```

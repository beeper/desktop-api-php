...
namespace BeeperDesktop\Matrix\Bridges\Auth\AuthSubmitUserInputResponse;

use BeeperDesktop\Core\Attributes\Optional;
use BeeperDesktop\Core\Attributes\Required;
use BeeperDesktop\Core\Concerns\SdkModel;
use BeeperDesktop\Core\Contracts\BaseModel;
use BeeperDesktop\Matrix\Bridges\Auth\AuthSubmitUserInputResponse\UnionMember0\DisplayAndWait;

/**
 * Display and wait login step.
 *
 * @phpstan-import-type DisplayAndWaitShape from \BeeperDesktop\Matrix\Bridges\Auth\AuthSubmitUserInputResponse\UnionMember0\DisplayAndWait
 *

...
use BeeperDesktop\App\Setup\SetupGetResponse\E2EE;
use BeeperDesktop\App\Setup\SetupGetResponse\Matrix;
use BeeperDesktop\App\Setup\SetupGetResponse\State;
use BeeperDesktop\App\Setup\SetupGetResponse\Verification;
...
/**
 * @phpstan-import-type E2EEShape from \BeeperDesktop\App\Setup\SetupGetResponse\E2EE
 * @phpstan-import-type MatrixShape from \BeeperDesktop\App\Setup\SetupGetResponse\Matrix
 * @phpstan-import-type VerificationShape from \BeeperDesktop\App\Setup\SetupGetResponse\Verification
 *
 * @phpstan-type SetupGetResponseShape = array{
 *   e2ee: E2EE|E2EEShape,
 ...
 * }
 */
final class SetupGetResponse implements BaseModel
{
    /** @use SdkModel<SetupGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new SetupGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SetupGetResponse::with(e2ee: ..., state: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SetupGetResponse)->withE2EE(...)->withState(...)
     * ```
     */

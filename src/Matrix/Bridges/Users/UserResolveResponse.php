 ...
 *
 * @phpstan-type UserResolveResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class UserResolveResponse implements BaseModel
{
    /** @use SdkModel<UserResolveResponseShape> */
    use SdkModel;
    ...
    /**
     * `new UserResolveResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UserResolveResponse::with(id: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UserResolveResponse)->withID(...)
     * ```
     */

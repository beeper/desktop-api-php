...
use BeeperDesktop\Matrix\Bridges\Auth\AuthStartLoginResponse\UnionMember1\UserInput;

/**
 * User input login step.
 *
 * @phpstan-import-type UserInputShape from \BeeperDesktop\Matrix\Bridges\Auth\AuthStartLoginResponse\UnionMember1\UserInput
 *

...
/**
 * @phpstan-type SetupStartResponseShape = array{
 *   setupRequestID: string, signInMethods: list<string>
 * }
 */
final class SetupStartResponse implements BaseModel
{
    /** @use SdkModel<SetupStartResponseShape> */
    use SdkModel;
    ...
    /**
     * `new SetupStartResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SetupStartResponse::with(setupRequestID: ..., signInMethods: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SetupStartResponse)->withSetupRequestID(...)->withSignInMethods(...)
     * ```
     */

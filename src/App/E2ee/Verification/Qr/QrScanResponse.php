...
use BeeperDesktop\App\E2ee\Verification\Qr\QrScanResponse\AppState;
use BeeperDesktop\Core\Attributes\Required;
use BeeperDesktop\Core\Concerns\SdkModel;
use BeeperDesktop\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type AppStateShape from \BeeperDesktop\App\E2ee\Verification\Qr\QrScanResponse\AppState
 *
 * @phpstan-type QrScanResponseShape = array{appState: AppState|AppStateShape}
 */
final class QrScanResponse implements BaseModel
{
     ...
     * ```
     * QrScanResponse::with(appState: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new QrScanResponse)->withAppState(...)
     * ```
     */

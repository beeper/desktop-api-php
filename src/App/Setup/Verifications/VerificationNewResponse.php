...
use BeeperDesktop\App\Setup\Verifications\VerificationNewResponse\Session;
use BeeperDesktop\App\Setup\Verifications\VerificationNewResponse\Verification;
...
/**
 * @phpstan-import-type SessionShape from \BeeperDesktop\App\Setup\Verifications\VerificationNewResponse\Session
 * @phpstan-import-type VerificationShape from \BeeperDesktop\App\Setup\Verifications\VerificationNewResponse\Verification
 *
...
final class VerificationNewResponse implements BaseModel
{
     ...
     * ```
     * VerificationNewResponse::with(session: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new VerificationNewResponse)->withSession(...)
     * ```
     */

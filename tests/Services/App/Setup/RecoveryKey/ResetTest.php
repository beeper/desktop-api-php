...
namespace Tests\Services\App\Setup\RecoveryKey;
...
final class ResetTest extends TestCase
{
    ...
    {
        $result = $this->client->app->setup->recoveryKey->reset->create();
    ...
    {
        $result = $this->client->app->setup->recoveryKey->reset->confirm(
            recoveryKey: 'x'
        );

...
use BeeperDesktop\App\AppStatusResponse\E2ee;
use BeeperDesktop\App\AppStatusResponse\Matrix;
use BeeperDesktop\App\AppStatusResponse\State;
use BeeperDesktop\App\AppStatusResponse\Verification;
...
/**
 * @phpstan-import-type E2eeShape from \BeeperDesktop\App\AppStatusResponse\E2ee
 * @phpstan-import-type MatrixShape from \BeeperDesktop\App\AppStatusResponse\Matrix
 * @phpstan-import-type VerificationShape from \BeeperDesktop\App\AppStatusResponse\Verification
 *
 * @phpstan-type AppStatusResponseShape = array{
 *   e2ee: E2ee|E2eeShape,
 ...
 * }
 */
final class AppStatusResponse implements BaseModel
{
    /** @use SdkModel<AppStatusResponseShape> */
    use SdkModel;
    ...
    /**
     * `new AppStatusResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AppStatusResponse::with(e2ee: ..., state: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AppStatusResponse)->withE2ee(...)->withState(...)
     * ```
     */

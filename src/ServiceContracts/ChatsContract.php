...
interface ChatsContract
{
     ...
     * @param int $limit Set the maximum number of chats to retrieve. Valid range: 1-200, default is 25
     * @param RequestOpts|null $requestOptions
     *
     ...
     * @param Inbox|value-of<Inbox> $inbox Filter by inbox type: "primary" (the chats the Beeper inbox shows: non-archived, non-low-priority, honoring inbox visibility rules and labels), "low-priority", or "archive". If not specified, shows all chats.
     ...
     * @param string $labelID Only include chats that carry this label. Label IDs come from GET /v1/labels.

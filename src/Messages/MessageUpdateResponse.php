...
use BeeperDesktop\Attachment;
use BeeperDesktop\Core\Attributes\Optional;
use BeeperDesktop\Core\Attributes\Required;
use BeeperDesktop\Core\Concerns\SdkModel;
use BeeperDesktop\Core\Contracts\BaseModel;
use BeeperDesktop\LinkPreview;
use BeeperDesktop\Message\Seen;
use BeeperDesktop\Message\Type;
use BeeperDesktop\Reaction;
use BeeperDesktop\SendStatus;
 ...
 * @phpstan-import-type LinkPreviewShape from \BeeperDesktop\LinkPreview
 ...
 * @phpstan-import-type SendStatusShape from \BeeperDesktop\SendStatus
 *
 ...
 *   links?: list<LinkPreview|LinkPreviewShape>|null,
...
final class MessageUpdateResponse implements BaseModel
{
     ...
     *
     * @var list<LinkPreview>|null $links
     */
    #[Optional(list: LinkPreview::class)]
    public ?array $links;
     ...
     * @param list<LinkPreview|LinkPreviewShape>|null $links
     ...
     * Link previews included with this message, if any.
     *
     * @param list<LinkPreview|LinkPreviewShape> $links
     */

...
namespace BeeperDesktop\Matrix\Bridges\Auth\AuthSubmitCookiesResponse\UnionMember2;

use BeeperDesktop\Core\Attributes\Optional;
use BeeperDesktop\Core\Attributes\Required;
use BeeperDesktop\Core\Concerns\SdkModel;
use BeeperDesktop\Core\Contracts\BaseModel;
use BeeperDesktop\Matrix\Bridges\Auth\AuthSubmitCookiesResponse\UnionMember2\Cookies\Field;

/**
 * Parameters for the cookie login step.
 *
 * @phpstan-import-type FieldShape from \BeeperDesktop\Matrix\Bridges\Auth\AuthSubmitCookiesResponse\UnionMember2\Cookies\Field
 *

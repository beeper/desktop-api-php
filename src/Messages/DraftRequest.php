...
final class DraftRequest implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new DraftRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DraftRequest::with(chatID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new DraftRequest)->withChatID(...)
     * ```
     */

...
use BeeperDesktop\ChatCapabilities\Delete;
use BeeperDesktop\ChatCapabilities\DisappearingTimer;
use BeeperDesktop\ChatCapabilities\Edit;
use BeeperDesktop\ChatCapabilities\Formatting;
use BeeperDesktop\ChatCapabilities\LocationMessage;
use BeeperDesktop\ChatCapabilities\MessageRequest;
use BeeperDesktop\ChatCapabilities\ParticipantActions;
use BeeperDesktop\ChatCapabilities\Poll;
use BeeperDesktop\ChatCapabilities\Reaction;
use BeeperDesktop\ChatCapabilities\Reply;
use BeeperDesktop\ChatCapabilities\Thread;
 ...
 *
 * @phpstan-import-type AttachmentCapabilitiesShape from \BeeperDesktop\AttachmentCapabilities
 * @phpstan-import-type DisappearingTimerShape from \BeeperDesktop\ChatCapabilities\DisappearingTimer
 * @phpstan-import-type MessageRequestShape from \BeeperDesktop\ChatCapabilities\MessageRequest
 * @phpstan-import-type ParticipantActionsShape from \BeeperDesktop\ChatCapabilities\ParticipantActions
 * @phpstan-import-type ChatStateCapabilitiesShape from \BeeperDesktop\ChatStateCapabilities
 *
 * @phpstan-type ChatCapabilitiesShape = array{
 *   allowedReactions?: list<string>|null,
 *   archive?: bool|null,
 *   attachments?: array<string,AttachmentCapabilities|AttachmentCapabilitiesShape>|null,
 ...
 *   reaction?: null|\BeeperDesktop\ChatCapabilities\Reaction|value-of<\BeeperDesktop\ChatCapabilities\Reaction>,
 *   reactionCount?: int|null,
 *   readReceipts?: bool|null,
 *   reply?: null|Reply|value-of<Reply>,
 *   state?: null|ChatStateCapabilities|ChatStateCapabilitiesShape,
 *   thread?: null|Thread|value-of<Thread>,
 *   typingNotifications?: bool|null,
 * }
 */
final class ChatCapabilities implements BaseModel
{
    /** @use SdkModel<ChatCapabilitiesShape> */
    use SdkModel;
     ...
     *
     * @var array<string,AttachmentCapabilities>|null $attachments
     */
    #[Optional(map: AttachmentCapabilities::class)]
     ...
     */
    #[Optional]
    public ?ChatStateCapabilities $state;
     ...
     * @param array<string,AttachmentCapabilities|AttachmentCapabilitiesShape>|null $attachments
     ...
     * @param ChatStateCapabilities|ChatStateCapabilitiesShape|null $state
    ...
    public static function with(
        ...
        ChatStateCapabilities|array|null $state = null,
     ...
     * Supported attachment message types and their per-type constraints, keyed by Matrix msgtype or pseudo-msgtype (for example m.image, m.video, org.matrix.msc3245.voice). Missing message types should be treated as rejected.
     *
     * @param array<string,AttachmentCapabilities|AttachmentCapabilitiesShape> $attachments
     */
     ...
     * Chat state update capabilities.
     *
     * @param ChatStateCapabilities|ChatStateCapabilitiesShape $state
     */
    public function withState(ChatStateCapabilities|array $state): self
    {
        $self = clone $this;
        $self['state'] = $state;

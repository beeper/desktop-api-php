 ...
 *
 * @phpstan-type RoomNewDmResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class RoomNewDmResponse implements BaseModel
{
    /** @use SdkModel<RoomNewDmResponseShape> */
    use SdkModel;
    ...
    /**
     * `new RoomNewDmResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RoomNewDmResponse::with(id: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new RoomNewDmResponse)->withID(...)
     * ```
     */

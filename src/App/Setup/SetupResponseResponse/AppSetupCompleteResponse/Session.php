...
namespace BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse;

use BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\E2EE;
use BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\Matrix;
use BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\State;
use BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\Verification;
 ...
 *
 * @phpstan-import-type E2EEShape from \BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\E2EE
 * @phpstan-import-type MatrixShape from \BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\Matrix
 * @phpstan-import-type VerificationShape from \BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\Verification
 *
 * @phpstan-type SessionShape = array{
 *   e2ee: E2EE|E2EEShape,
 *   state: State|value-of<State>,
 *   matrix?: null|\BeeperDesktop\App\Setup\SetupResponseResponse\AppSetupCompleteResponse\Session\Matrix|MatrixShape,

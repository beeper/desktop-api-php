...
use BeeperDesktop\Bridges\BridgeLogin\RemoveScope;
use BeeperDesktop\Bridges\BridgeLogin\Status;
 ...
 *
 * @phpstan-type BridgeLoginShape = array{
 *   bridgeID: string,
 *   loginID: string,
 ...
 * }
 */
final class BridgeLogin implements BaseModel
{
    /** @use SdkModel<BridgeLoginShape> */
    use SdkModel;
    ...
    /**
     * `new BridgeLogin()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BridgeLogin::with(bridgeID: ..., loginID: ..., removeScopes: ..., status: ...)
     * ```
     *

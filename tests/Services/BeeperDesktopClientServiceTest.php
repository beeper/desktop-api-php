 ...
 */
#[CoversNothing]
final class BeeperDesktopClientServiceTest extends TestCase
{
    ...
    {
        $result = $this->client->focus();

        // @phpstan-ignore-next-line method.alreadyNarrowedType
        $this->assertInstanceOf(
            BeeperDesktopClientServiceFocusResponse::class,
            $result
        );
    }
    ...
    {
        $result = $this->client->search(query: 'x');

        // @phpstan-ignore-next-line method.alreadyNarrowedType
        $this->assertInstanceOf(
            BeeperDesktopClientServiceSearchResponse::class,
            $result
        );
    }

...
use BeeperDesktop\App\E2ee\Verification\VerificationCancelResponse\AppState;
use BeeperDesktop\Core\Attributes\Required;
use BeeperDesktop\Core\Concerns\SdkModel;
use BeeperDesktop\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type AppStateShape from \BeeperDesktop\App\E2ee\Verification\VerificationCancelResponse\AppState
 *
...
final class VerificationCancelResponse implements BaseModel
{
     ...
     * ```
     * VerificationCancelResponse::with(appState: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new VerificationCancelResponse)->withAppState(...)
     * ```
     */

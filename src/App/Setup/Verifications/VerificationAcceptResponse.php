...
use BeeperDesktop\App\Setup\Verifications\VerificationAcceptResponse\Session;
use BeeperDesktop\App\Setup\Verifications\VerificationAcceptResponse\Verification;
...
/**
 * @phpstan-import-type SessionShape from \BeeperDesktop\App\Setup\Verifications\VerificationAcceptResponse\Session
 * @phpstan-import-type VerificationShape from \BeeperDesktop\App\Setup\Verifications\VerificationAcceptResponse\Verification
 *
...
final class VerificationAcceptResponse implements BaseModel
{
     ...
     * ```
     * VerificationAcceptResponse::with(session: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new VerificationAcceptResponse)->withSession(...)
     * ```
     */

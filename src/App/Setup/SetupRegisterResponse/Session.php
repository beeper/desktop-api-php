...
namespace BeeperDesktop\App\Setup\SetupRegisterResponse;

use BeeperDesktop\App\Setup\SetupRegisterResponse\Session\E2EE;
use BeeperDesktop\App\Setup\SetupRegisterResponse\Session\Matrix;
use BeeperDesktop\App\Setup\SetupRegisterResponse\Session\State;
use BeeperDesktop\App\Setup\SetupRegisterResponse\Session\Verification;
 ...
 *
 * @phpstan-import-type E2EEShape from \BeeperDesktop\App\Setup\SetupRegisterResponse\Session\E2EE
 * @phpstan-import-type MatrixShape from \BeeperDesktop\App\Setup\SetupRegisterResponse\Session\Matrix
 * @phpstan-import-type VerificationShape from \BeeperDesktop\App\Setup\SetupRegisterResponse\Session\Verification
 *
 * @phpstan-type SessionShape = array{
 *   e2ee: E2EE|E2EEShape,
 *   state: State|value-of<State>,
 *   matrix?: null|\BeeperDesktop\App\Setup\SetupRegisterResponse\Session\Matrix|MatrixShape,

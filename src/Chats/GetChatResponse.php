...
use BeeperDesktop\Chats\GetChatResponse\Participants;
use BeeperDesktop\Chats\GetChatResponse\Type;
use BeeperDesktop\Core\Attributes\Api;
use BeeperDesktop\Core\Concerns\SdkModel;
use BeeperDesktop\Core\Contracts\BaseModel;

final class GetChatResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new GetChatResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GetChatResponse::with(
     *   id: ...,
     *   accountID: ...,
     *   chatID: ...,
     *   network: ...,

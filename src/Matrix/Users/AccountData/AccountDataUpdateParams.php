 ...
 *
 * @see BeeperDesktop\Services\Matrix\Users\AccountDataService::update()
 *
 * @phpstan-type AccountDataUpdateParamsShape = array{userID: string, body: mixed}
 */
final class AccountDataUpdateParams implements BaseModel
{
     ...
     * ```
     * AccountDataUpdateParams::with(userID: ..., body: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AccountDataUpdateParams)->withUserID(...)->withBody(...)
     * ```
     */
     ...
     */
    public static function with(string $userID, mixed $body): self
    {
        $self = new self;

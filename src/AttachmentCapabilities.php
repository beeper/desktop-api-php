...
use BeeperDesktop\AttachmentCapabilities\Caption;
use BeeperDesktop\AttachmentCapabilities\MimeType;
 ...
 *
 * @phpstan-type AttachmentCapabilitiesShape = array{
 ...
 * }
 */
final class AttachmentCapabilities implements BaseModel
{
    /** @use SdkModel<AttachmentCapabilitiesShape> */
    use SdkModel;
    ...
    /**
     * `new AttachmentCapabilities()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AttachmentCapabilities::with(mimeTypes: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AttachmentCapabilities)->withMimeTypes(...)
     * ```
     */

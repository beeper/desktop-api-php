...
final class DisplayAndWaitLoginStep implements BaseModel
{
    ...
    #[Required]
    public QRCodeLoginDisplay|EmojiLoginDisplay|CodeLoginDisplay|EmptyLoginDisplay $display;
    ...
    public static function with(
        QRCodeLoginDisplay|array|EmojiLoginDisplay|CodeLoginDisplay|EmptyLoginDisplay $display,
        string $stepID,

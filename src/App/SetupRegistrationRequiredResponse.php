...
use BeeperDesktop\App\SetupRegistrationRequiredResponse\Copy;
...
/**
 * @phpstan-import-type CopyShape from \BeeperDesktop\App\SetupRegistrationRequiredResponse\Copy
 *
 * @phpstan-type SetupRegistrationRequiredResponseShape = array{
 *   copy: Copy|CopyShape,
 *   leadToken: string,
 ...
 * }
 */
final class SetupRegistrationRequiredResponse implements BaseModel
{
    /** @use SdkModel<SetupRegistrationRequiredResponseShape> */
    use SdkModel;
    ...
    /**
     * `new SetupRegistrationRequiredResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SetupRegistrationRequiredResponse::with(
     ...
     *
     * ```
     * (new SetupRegistrationRequiredResponse)
     *   ->withCopy(...)
     *   ->withLeadToken(...)
     *   ->withSetupRequestID(...)
     * ```

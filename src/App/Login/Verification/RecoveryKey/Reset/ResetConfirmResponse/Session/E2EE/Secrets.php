...
namespace BeeperDesktop\App\Login\Verification\RecoveryKey\Reset\ResetConfirmResponse\Session\E2EE;
...
final class Secrets implements BaseModel
{
     ...
     * Whether a recovery key is available.
     */
    public function withRecoveryKey(bool $recoveryKey): self
    {
        $self = clone $this;
        $self['recoveryKey'] = $recoveryKey;

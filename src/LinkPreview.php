...
use BeeperDesktop\LinkPreview\ImgSize;

/**
 * Link preview included with a message.
 *
 * @phpstan-import-type ImgSizeShape from \BeeperDesktop\LinkPreview\ImgSize
 *
 * @phpstan-type LinkPreviewShape = array{
 *   title: string,
 *   url: string,
 *   favicon?: string|null,
 *   img?: string|null,
 ...
 * }
 */
final class LinkPreview implements BaseModel
{
    /** @use SdkModel<LinkPreviewShape> */
    use SdkModel;
    ...
    /**
     * `new LinkPreview()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LinkPreview::with(title: ..., url: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new LinkPreview)->withTitle(...)->withURL(...)
     * ```
     */

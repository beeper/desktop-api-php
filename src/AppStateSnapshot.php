 ...
 * }
 */
final class AppStateSnapshot implements BaseModel
{
    /** @use SdkModel<AppStateSnapshotShape> */
    use SdkModel;
    ...
    /**
     * `new AppStateSnapshot()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AppStateSnapshot::with(e2ee: ..., state: ...)
     * ```
     *

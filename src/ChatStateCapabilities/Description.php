...
namespace BeeperDesktop\ChatStateCapabilities;

use BeeperDesktop\ChatStateCapabilities\Description\Level;
 ...
 *
 * @phpstan-type DescriptionShape = array{level: Level|value-of<Level>}
 */
final class Description implements BaseModel
{
    ...
    /**
     * `new Description()` is missing required properties by the API.
     *

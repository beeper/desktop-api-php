...
namespace BeeperDesktop\Matrix\Bridges\Auth\AuthStartLoginResponse\UnionMember1;

use BeeperDesktop\Core\Attributes\Optional;
use BeeperDesktop\Core\Attributes\Required;
use BeeperDesktop\Core\Concerns\SdkModel;
use BeeperDesktop\Core\Contracts\BaseModel;
use BeeperDesktop\Matrix\Bridges\Auth\AuthStartLoginResponse\UnionMember1\UserInput\Attachment;
use BeeperDesktop\Matrix\Bridges\Auth\AuthStartLoginResponse\UnionMember1\UserInput\Field;

/**
 * Parameters for the user input login step.
 *
 * @phpstan-import-type FieldShape from \BeeperDesktop\Matrix\Bridges\Auth\AuthStartLoginResponse\UnionMember1\UserInput\Field
 * @phpstan-import-type AttachmentShape from \BeeperDesktop\Matrix\Bridges\Auth\AuthStartLoginResponse\UnionMember1\UserInput\Attachment
 *
